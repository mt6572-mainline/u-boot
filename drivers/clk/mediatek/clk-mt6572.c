...
static const struct mtk_pll_data apmixed_plls[] = {
  PLL(CLK_APMIXED_ARMPLL, 0x100, 0x110, 0x11, 0, 21, 0x104, 24, 0x104, 0),
  PLL(CLK_APMIXED_MAINPLL, 0x120, 0x130, 0x11, HAVE_RST_BAR, 21, 0x124, 24, 0x124, 0),
  PLL(CLK_APMIXED_UNIVPLL, 0x140, 0x150, 0x30000011, HAVE_RST_BAR, 7, 0x144, 24, 0x144, 0),
  PLL(CLK_APMIXED_MCUPLL, 0x220, 0x230, 0x11, 0, 21, 0x224, 24, 0x224, 0),
  PLL(CLK_APMIXED_WHPLL, 0x240, 0x250, 0x11, 0, 21, 0x244, 24, 0x244, 0),
  PLL(CLK_APMIXED_WPLL, 0x260, 0x270, 0x11, 0, 10, 0x264, 24, 0x264, 0),
};
